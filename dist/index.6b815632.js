...
parcelHelpers.export(exports, "findLinksEMails", ()=>findLinksEMails
);
...
var _inboxEmail = require("./inbox/inbox-email");
var _inboxList = require("./inbox/inbox-list");
var _sentList = require("./sent/sent-list");
var _sentEmail = require("./sent/sent-email");
...
function router(path) {
    ...
    const routes = [
        {
            path: /inbox/,
            handler: _inboxList.inboxHtml,
            text: "inbox"
        },
        {
            path: /sent/,
            handler: _sentList.sentHtml,
            text: "sent"
        },
        {
            path: /\/inbox\/./,
            handler: _inboxEmail.emailInbox,
            text: "inbox con algo"
        },
        {
            path: /\/sent\/./,
            handler: _sentEmail.emailSent,
            text: "sent con algo"
        }, 
    ];
    for (const i of routes)if (i.path.test(path)) {
        const el = i.handler();
        console.log(i.text);
        const container = document.querySelector(".container");
        if (container.firstChild) container.firstChild.remove();
        container.appendChild(el);
        _app.findLinksEMails(el);
    }
}

},{"./inbox/inbox-email":"eYoDq","./inbox/inbox-list":"dkuYb","./sent/sent-list":"h9Myy","./sent/sent-email":"dHJ0k","./app":"kuM8f","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eYoDq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "emailInbox", ()=>emailInbox
);
function emailInbox() {
...
},{}],"dkuYb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "inboxHtml", ()=>inboxHtml
);
function inboxHtml() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h9Myy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sentHtml", ()=>sentHtml
);
function sentHtml() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dHJ0k":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "emailSent", ()=>emailSent
);
function emailSent() {
    const email = document.createElement("div");
    const emailId = location.pathname.split("/")[2];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["g75ug","kuM8f"], "kuM8f", "parcelRequire4bd0")
